...
\begin{itemize}
    ...
    \item $a_{safe}, s_{safe}$: thresholds defining the safe operating region (defaults: 0.60, 0.55)
\end{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_arc_architecture_v2.png}
...
\begin{table}[h]
\centering
\caption{L5 Adversarial Safety Results}
...
We conducted independent t-tests comparing ARC vs baseline (no\_control) for each metric and research line (Table \ref{tab:significance}):
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_heatmap_rt.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_heatmap_effort.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/correlation_combined.png}
...
\subsection{G.2 Line 2: Memory and Continuous Learning}
