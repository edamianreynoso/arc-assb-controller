...
\usepackage{mathpazo}  % Palatino font for elegance
...
\date{December 14, 2025\\{\small Version 1.2 (arXiv submission draft)}}
...
\midrule
\endhead
$\mathbf{x}(t)$ & Internal state vector & $\mathbb{R}^{10}$ & Section~\ref{sec:state-space} \\
$\Phi$ & Integration proxy (IIT) & $[0, 1]$ & Section~\ref{sec:state-space} \\
$G$ & Global workspace access & $[0, 1]$ & Section~\ref{sec:state-space} \\
$P$ & Predictive precision & $[0, 1]$ & Section~\ref{sec:state-space} \\
$I$ & Introspective attention & $[0, 1]$ & Section~\ref{sec:state-space} \\
$S$ & Narrative Intensity (DMN) & $[0, 1]$ & Section~\ref{sec:state-space} \\
$V$ & Valence & $[0, 1]$ & Section~\ref{sec:state-space} \\
$A$ & Arousal & $[0, 1]$ & Section~\ref{sec:state-space} \\
$M_f, M_s$ & Fast/Slow memory trace & $[0, 1]$ & Section~\ref{sec:state-space} \\
$U$ & Uncertainty & $[0, 1]$ & Section~\ref{sec:state-space} \\
$\mathbf{u}(t)$ & Control actions vector & $[0, 1]^5$ & Section~\ref{sec:control-actions} \\
Perf & Performance proxy & $[0, 1]$ & Section~\ref{sec:perf-function} \\
$a_{safe}$ & Arousal threshold & 0.60 & Section~\ref{sec:perf-function} \\
$s_{safe}$ & Narrative threshold & 0.55 & Section~\ref{sec:perf-function} \\
\bottomrule
\end{longtable}
