...
\usepackage{mathpazo} % Palatino font (stable on MiKTeX/arXiv)
\usepackage{amsmath,amssymb,amsthm}
\usepackage[protrusion=true,expansion=false]{microtype} % expansion can break with some font setups
